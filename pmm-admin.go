...
func main() {
	...
	cmdAddMySQL.Flags().BoolVar(&flagM.DisableEventsWaits, "disable-eventswaits", false, "disable eventswaits/file_events metrics")
	...
	cmdAddMySQLMetrics.Flags().BoolVar(&flagM.DisableEventsWaits, "disable-eventswaits", false, "disable eventswaits/file_events metrics")
